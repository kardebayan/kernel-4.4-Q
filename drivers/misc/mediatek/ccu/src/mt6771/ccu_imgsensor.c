...
void ccu_get_sensor_i2c_slave_addr(int32_t *sensorI2cSlaveAddr)
{
	...
	sensorI2cSlaveAddr[3] = g_ccu_sensor_info[IMGSENSOR_SENSOR_IDX_MAIN3].slave_addr;
}
...
void ccu_get_sensor_name(char **sensor_name)
{
	...
	sensor_name[3] = g_ccu_sensor_info[IMGSENSOR_SENSOR_IDX_MAIN3].sensor_name_string;
}
